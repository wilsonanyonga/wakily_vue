<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="$t('table.name')" prop="name" width="auto" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.name }}</span>
        </template>
      </el-table-column>

      <el-table-column :label="$t('table.email')" prop="email" width="auto" align="center">
        <template slot-scope="scope">
...
export default {
  ...
  methods: {
    getList() {
      ...
      this.$store.dispatch('user/fetchList').then(response => {
    ...
    updateForm() {
          this.$refs.dataForm.validate(valid => {
            if (valid) {
              ...
              this.$store.dispatch('user/updateData', this.temp)
